...
1. **Exercise 01 - Coimbatore Georeferencing** — georeference a scanned map and compare it with OpenStreetMap tiles.
...
The Exercise 4 disease values are synthetic practice data and are not suitable for real public-health decisions.
