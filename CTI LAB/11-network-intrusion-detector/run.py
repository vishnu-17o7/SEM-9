"""Unified entry point for Network Intrusion Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Download NSL-KDD dataset
    train     Train NIDS model
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Network Intrusion Detector -- unified runner")
    ...
    if cmd == "all":
        steps: list[list[str]] = [["download_nsl_kdd.py"], ["train_nids.py"]]
        run_scripts(steps)
