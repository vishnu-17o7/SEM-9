"""Unified entry point for Malicious PDF Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Generate PDF feature dataset
    train     Train malicious PDF classifier
...
COMMANDS: dict[str, list[list[str]]] = {
    "data": [["generate_pdf_data.py"]],
    "train": [["train_pdf_model.py"]],
    "report": [["report.py"]],
}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Malicious PDF Detector -- unified runner")
    ...
    if cmd == "all":
        steps: list[list[str]] = [["generate_pdf_data.py"], ["train_pdf_model.py"]]
        run_scripts(steps)
