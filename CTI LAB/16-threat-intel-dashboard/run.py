"""Unified entry point for Threat Intel Dashboard.

Usage:
    python run.py <command> [options]

Commands:
    web       Launch Flask dashboard (port 5002)
    all       Launch dashboard
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Threat Intel Dashboard -- unified runner")
    ...
    if cmd == "all" and WEB_SCRIPT:
        run_scripts([[WEB_SCRIPT]])
        return
