"""Generate HTML report for ransomware detection."""
...
def plot_cm(cm, labels, title):
    ...
    ax.imshow(cm, interpolation="nearest", cmap=plt.cm.RdYlGn_r)
...
def generate_report():
    if not METRICS_JSON.exists(): print("Run train_ransomware_model.py first."); return
...
<title>Ransomware Behavior Detection</title><style>*{{margin:0;padding:0;box-sizing:border-box}}
...
<div class="container">
<h1>Ransomware Behavior Detection</h1>
<p class="subtitle">29 System Activity Features — {len(metrics)} Models</p>
