"""Unified entry point for Malicious Executable Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Generate PE feature dataset
    train     Train malware detection model
...
COMMANDS: dict[str, list[list[str]]] = {
    "data": [["generate_pe_features.py"]],
    "train": [["train_malware_model.py"]],
    "report": [["report.py"]],
}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Malicious Executable Detector -- unified runner")
    ...
    if cmd == "all":
        steps: list[list[str]] = [["generate_pe_features.py"], ["train_malware_model.py"]]
        run_scripts(steps)
