"""Unified entry point for Phishing URL Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Build the phishing URL dataset
    train     Train and compare ML models
    report    Generate HTML report
    classify  Classify a URL (interactive CLI)
    web       Launch Flask web UI (port 5000)
...
CLASSIFY_SCRIPT: str | None = "phishing_classifier.py"
