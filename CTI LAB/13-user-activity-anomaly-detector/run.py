"""Unified entry point for User Activity Anomaly Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Generate user activity data
...
COMMANDS: dict[str, list[list[str]]] = {
    "data": [["generate_activity_data.py"]],
    "train": [["detect_anomalies.py"]],
    "report": [["report.py"]],
}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="User Activity Anomaly Detector -- unified runner")
    ...
    if cmd == "all":
        steps: list[list[str]] = [["generate_activity_data.py"], ["detect_anomalies.py"]]
        run_scripts(steps)
