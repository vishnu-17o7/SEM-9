"""Unified entry point for Crypto-Ransomware Detector.

Usage:
    python run.py <command> [options]

Commands:
    data      Simulate crypto-ransomware data
    train     Train crypto-ransomware detector
...
COMMANDS: dict[str, list[list[str]]] = {
    "data": [["simulate_crypto_ransomware.py"]],
    "train": [["train_crypto_model.py"]],
    "report": [["report.py"]],
}
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Crypto-Ransomware Detector -- unified runner")
    ...
    if cmd == "all":
        steps: list[list[str]] = [["simulate_crypto_ransomware.py"], ["train_crypto_model.py"]]
        run_scripts(steps)
